...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    '大家好，这是一个测试项目，先尝试记录一下',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Jason', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '时代见证和记录', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.jason4788.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion,博客,思考,记录', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'tiancun@gmail.com', // 邮箱地址 例如mail@tangly1024.com
